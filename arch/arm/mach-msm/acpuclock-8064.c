...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  81000, PLL_8, 0, 0x00 },  800000, 800000, 1 },
	[1]  = { {  192000, HFPLL, 2, 0x20 },  950000, 950000, 2 },
	[2]  = { {  384000, HFPLL, 2, 0x24 },  950000, 950000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 },  950000, 950000, 2 },
	[4]  = { {  594000, HFPLL, 1, 0x16 },  950000, 950000, 2 },
	[5]  = { {  648000, HFPLL, 1, 0x18 },  950000, 950000, 2 },
	[6]  = { {  702000, HFPLL, 1, 0x1A },  950000, 950000, 2 },
	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1050000, 1050000, 4 },
	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1050000, 1050000, 4 },
	[9]  = { {  864000, HFPLL, 1, 0x20 }, 1050000, 1050000, 4 },
	[10] = { {  918000, HFPLL, 1, 0x22 }, 1050000, 1050000, 5 },
	[11] = { {  972000, HFPLL, 1, 0x24 }, 1050000, 1050000, 5 },
	[12] = { { 1026000, HFPLL, 1, 0x26 }, 1050000, 1050000, 5 },
...
static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {    81000, PLL_8, 0, 0x00 }, L2(0),   800000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   825000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	//{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   975000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(5),   900000 },
	//{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),  1000000 },
	//{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),  1025000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   925000 },
	//{ 0, {   756000, HFPLL, 1, 0x1C }, L2(5),  1075000 },
	//{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),  1075000 },
	//{ 1, {   864000, HFPLL, 1, 0x20 }, L2(5),  1000000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {    81000, PLL_8, 0, 0x00 }, L2(0),   750000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   775000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   825000 },
	//{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(5),   850000 },
	...
	//{ 1, {   864000, HFPLL, 1, 0x20 }, L2(5),   950000 },
	//{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),  1050000 },
	//{ 0, {   972000, HFPLL, 1, 0x24 }, L2(5),  1075000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),   975000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {    81000, PLL_8, 0, 0x00 }, L2(0),   700000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   725000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   775000 },
	//{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(5),   800000 },
	//{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	//{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   825000 },
	//{ 0, {   756000, HFPLL, 1, 0x1C }, L2(5),   975000 },
	//{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   975000 },
	//{ 1, {   864000, HFPLL, 1, 0x20 }, L2(5),   900000 },
	//{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),  1000000 },
	//{ 0, {   972000, HFPLL, 1, 0x24 }, L2(5),  1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(15),   925000 },
