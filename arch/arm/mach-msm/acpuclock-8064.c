...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[6] = BW_MBPS(5290), /* At least 600 MHz on bus. */
};
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(0),   875000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   975000 },
	//{ 1, {   540000, HFPLL, 2, 0x28 }, L2(5),   950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),  1000000 },
	//{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),  1025000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(14),   975000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(0),   825000 },
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(14),   925000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(14),   975000 },
...
static struct acpu_level tbl_faster[] __initdata = {
	{ 1, {    81000, PLL_8, 0, 0x00 }, L2(0),   750000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(0),   755000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   825000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	//{ 0, {   540000, HFPLL, 2, 0x28 }, L2(5),   850000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	//{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(14),   875000 },
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(14),   950000 },
